...
public class RequestParamController {
    ...
    /**
     * @RequestParam 사용 String, int  등의 단순 타입이라면 @RequestParam 도 생략 가능
     */
    @ResponseBody
     ...
     * <p>
     * 주의! /request-param-required ing age -> null 을 int에 입력하는 것은 불가능. 따라서 Integer 변경해야 함(또는 다음에 나오는 defaultValue 사용)
     */
    @ResponseBody
